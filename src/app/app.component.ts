  ...
  ngOnInit(){
	(function($) {
	    ...
	    function siteToggleAction() {
	        ...
	        $('#filter-sidebar').on('click', function(e: any) {
	            e.preventDefault();
	            filterSidebar.addClass('active');
	            $('.ps-site-overlay').addClass('active');
	        });

	        $('.ps-filter--sidebar .ps-filter__header .ps-btn--close').on('click', function(e: any) {
	            e.preventDefault();
	    ...
	    function subMenuToggle() {
	        $('.menu--mobile .menu-item-has-children > .sub-toggle').on('click', function(e: any) {
	            e.preventDefault();
	        ...
	        $('.menu--mobile .has-mega-menu .mega-menu__column .sub-toggle').on('click', function(e: any) {
	            e.preventDefault();
	        ...
	        if (listCategories.length > 0) {
	            $('.ps-list--categories .menu-item-has-children > .sub-toggle').on('click', function(e: any) {
	                e.preventDefault();
	                var current = $(this).parent('.menu-item-has-children')
	                $(this).toggleClass('active');
	                current.siblings().find('.sub-toggle').removeClass('active');
	    ...
	    function tabs() {
	        ...
	        $('.ps-tab-list.owl-slider .owl-item a').on('click', function(e:any) {
	            e.preventDefault();
	            var target = $(this).attr('href');
	    ...
	    function modalInit() {
	        ...
	        $('.ps-modal').on("click", function(event: any) {
	    ...
	    function searchInit() {
	        ...
	        $('.ps-search-btn').on('click', function(e:any) {
	            e.preventDefault();
	            searchbox.addClass('active');
	        });
	        searchbox.find('.ps-btn--close').on('click', function(e:any) {
	            e.preventDefault();
	    ...
	    function productFilterToggle() {
	        ...
	        if ($('.ps-sidebar--home').length > 0) {
	            $('.ps-sidebar--home > .ps-sidebar__header > a').on('click', function(e:any) {
	                e.preventDefault();
	    ...
	    function subscribePopup() {
	        ...
	        $('#subscribe').on("click", function(event:any) {
	    ...
	    function accordion() {
	        ...
	        accordion.find('.ps-accordion__header').on('click', function(e:any) {
	            e.preventDefault();
